...
For every video frame, the binary image generated by applying the mask described above was warped to a bird's eye view perspective. Warping was done using the matrices generated by **get_persprective_transforms()**. A sample of applying perpective correction can be viewed in the lane seach section below.


## Lane Search
After appying warping the every 
